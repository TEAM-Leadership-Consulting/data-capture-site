...
export default function ImportantDatesPage() {
  ...
  function getStatusIcon(status: string, isUrgent?: boolean) {
    if (status === 'today') return <AlertTriangle className="h-5 w-5 text-orange-500" />
  ...
  function getTypeIcon(type: string) {
    switch (type) {
      ...
      case 'milestone': return <CheckCircle className="h-6 w-6" />
      case 'announcement': return <Info className="h-6 w-6" />
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      {/* Key Dates Summary - Matching Home Page Style */}
      <section className="py-12 bg-gradient-to-r from-indigo-200 via-blue-100 to-indigo-200 border-l-8 border-indigo-500 border-r-8">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 bg-white rounded-lg shadow-sm border p-6">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          <h3 className="text-xl font-bold text-gray-900 mb-1">{date.title}</h3>
                      ...
                      <div className="flex items-center text-gray-600 mb-3">
                        ...
                        <span className="font-medium">{formatDate(date.date, date.time)}</span>
                      ...
                      <p className="text-gray-700 leading-relaxed">{date.description}</p>
            ...
            {filteredDates.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 text-lg">No dates found matching your filter criteria.</p>
              </div>
            )}
